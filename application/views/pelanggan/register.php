    ...
    <div class="register-box">
      ...
      <div class="card">
        <div class="card-body register-card-body bg-dark">
          <p class="login-box-msg text-warning">Register Pelanggan</p>
          ...
          <?php
            ...
            echo form_open('auth/register_pelanggan');
          ?>
            <div class="input-group mb-3">
              <input type="text" name="nama_pelanggan" value="<?= set_value('nama_pelanggan') ?>" class="form-control bg-dark" placeholder="Nama Pelanggan">
            ...
            <div class="input-group mb-3">
              <input type="password" name="retype_password" value="<?= set_value('retype_password') ?>" class="form-control bg-dark" placeholder="Retype Password">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-lock text-warning"></span>
                </div>
            ...
            <div class="row">
              <div class="col-6">
                <a href="<?= base_url('auth/login_pelanggan') ?>" class="btn btn-success btn-block">Log In</a>
              </div>
              <div class="col-6">
